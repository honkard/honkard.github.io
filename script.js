...
document.addEventListener('DOMContentLoaded', () => {
  ...
  function initializeVisitorCounter() {
    let totalVisitors = localStorage.getItem('totalVisitorCount_v3');
    if (!totalVisitors) {
      totalVisitors = 3123;
      localStorage.setItem('totalVisitorCount_v3', totalVisitors);
    } else {
...
if (hackerButton) {
  hackerButton.addEventListener('click', () => {
    switchTheme('assets/hacker_background.mp4', backgroundMusic, 'home-theme');
  });
}

if (rainButton) {
  rainButton.addEventListener('click', () => {
    switchTheme('assets/rain_background.mp4', backgroundMusic, 'home-theme');
  });
}

if (animeButton) {
  animeButton.addEventListener('click', () => {
    switchTheme('assets/anime_background.mp4', backgroundMusic, 'home-theme');
  });
}

if (carButton) {
  carButton.addEventListener('click', () => {
    switchTheme('assets/car_background.mp4', backgroundMusic, 'home-theme');
  });
}
...
window.addEventListener("load", () => {
  ...
  if (backgroundVideo) {
    backgroundVideo.src = "assets/anime_background.mp4";
  }
  ...
  if (animeMusic) {
    animeMusic.volume = 0.3;
  }
});

function copyDiscord() {
  navigator.clipboard.writeText("honkard");
  alert("Copied!");
}
